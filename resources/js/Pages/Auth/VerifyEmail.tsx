                        ...
                        <form onSubmit={submit}>
                            <div className="mt-4 flex items-center justify-between">
                                ...
                                <Link
                                    ...
                                    method="post"
                                    as="button"
                                    className="rounded-md text-sm text-gray-600 dark:text-gray-400 underline hover:text-gray-900 hover:dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                >
                                    Log Out
                                </Link>
                            </div>
